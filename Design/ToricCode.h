...
ap_uint<BITSACCURACY> north(ap_uint<BITSACCURACY> v);
ap_uint<BITSACCURACY> south(ap_uint<BITSACCURACY> v);
ap_uint<BITSACCURACY> east(ap_uint<BITSACCURACY> v);
ap_uint<BITSACCURACY> west(ap_uint<BITSACCURACY> v);
